...
export declare type MyReviewCardOverridesProps = {
    MyReviewCard?: PrimitiveOverrideProps<FlexProps>;
...
export declare type MyReviewCardProps = React.PropsWithChildren<Partial<FlexProps> & {
    overrides?: MyReviewCardOverridesProps | undefined | null;
}>;
export default function MyReviewCard(props: MyReviewCardProps): React.ReactElement;
